...
/* Used for parser to check if program starts with program
   and send a token */

/******************************************************/
/* main driver */
//void Scanner() {
//	/* Open the input data fileand process its contents */
...
int lex() {
	...
	//fprintf(out_fp, "%s %d\n", lexeme , nextToken);
	//ParseStruct.Tokenizer = nextToken;
	//sprintf(ParseStruct.word, "%s", lexeme);
	return nextToken;
} /* End of function lex */